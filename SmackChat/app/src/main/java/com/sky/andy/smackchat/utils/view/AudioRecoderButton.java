...
import com.sky.andy.smackchat.manager.AudioManager;
import com.sky.andy.smackchat.manager.DialogManager;


/**
 * Created by user on 2015/11/30.
 */
public class AudioRecoderButton extends TextView implements AudioManager.AudioStateListener {
